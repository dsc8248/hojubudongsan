          ...
          'commands' => array(
            ...
            'disable' => array(
              array('selector' => 'body', 'action' => 'removeClass', 'arguments' => array('brown-dark'))
				...
				'realia_hojubudongsan' => array(
					'file' => drupal_get_path('theme', 'realia') . '/css/realia-hojubudongsan.css',
					'label' => t('Hojubudongsan'),
					'commands' => array(
						'enable' => array(
							array('selector' => 'body', 'action' => 'addClass', 'arguments' => array('hojubudongsan'))
						),
						'disable' => array(
							array('selector' => 'body', 'action' => 'removeClass', 'arguments' => array('hojubudongsan'))
						)
					)
				),
      )
